...
export const faqItems: FAQItem[] = [
  ...
  {
    id: 5,
    question: "Czy można zobaczyć przykładowe realizacje?",
    answer:
      "Oczywiście! Zapraszamy do naszego showroomu przy ul. Gdańskiej 15 w Bydgoszczy, gdzie można zobaczyć przykładowe meble i materiały. Dodatkowo na naszej stronie znajduje się galeria zrealizowanych projektów.",
    category: "general",
  },
  {
    id: 6,
