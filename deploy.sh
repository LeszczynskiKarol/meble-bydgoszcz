...
S3_BUCKET="meble-bydgoszcz-static"  # Nazwa bucketu S3
CLOUDFRONT_ID="E30D0R03T5Q0AH"  # Twoje CloudFront Distribution ID
REGION="eu-central-1"
...
main() {
    ...
    echo "│                                        │"
    echo "│ 🌐 https://d2zn9iio3uwyfn.cloudfront.net │"
    echo "│                                        │"
...
if [[ $REPLY =~ ^[Tt]$ ]]; then
    if command -v xdg-open &> /dev/null; then
        xdg-open "https://www.meble-bydgoszcz.pl"
    elif command -v open &> /dev/null; then
        open "https://www.meble-bydgoszcz.pl"
    else
        echo "Otwórz w przeglądarce: https://www.meble-bydgoszcz.pl"
    fi
fi